...
function ASHP(;
    ...
    cop_heating::Array{<:Real,1} = Real[], # COP of the heating (i.e., thermal produced / electricity consumed)
    cop_cooling::Array{<:Real,1} = Real[], # COP of the heating (i.e., thermal produced / electricity consumed)
