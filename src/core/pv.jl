...
```julia
    ...
    macrs_bonus_fraction::Real = 0.6, #Note: default may change if Site.sector is not "commercial/industrial"
    ...
    federal_itc_fraction::Real = 0.3, #Note: default may change if Site.sector is not "commercial/industrial"
