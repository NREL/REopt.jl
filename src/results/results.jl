...
function combine_results(p::REoptInputs, bau::Dict, opt::Dict, bau_scenario::BAUScenario)
    bau_outputs = (
        ...
        ("ElectricTariff", "annual_electric_gross_purchase_cost_series"),
        ("ElectricTariff", "monthly_electric_gross_purchase_cost_series"),
        ("ElectricTariff", "monthly_facility_demand_cost_series"),
        ("ElectricTariff", "tou_demand_cost_series"),
        ("ElectricTariff", "monthly_tou_demand_cost_series"),
