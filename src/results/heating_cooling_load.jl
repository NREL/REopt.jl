...
function add_heating_load_results(m::JuMP.AbstractModel, p::REoptInputs, d::Dict; _n="")
    ...
    r["total_heating_thermal_load_series_mmbtu_per_hour"] = (r["dhw_thermal_load_series_mmbtu_per_hour"] .+ 
                                                            r["space_heating_thermal_load_series_mmbtu_per_hour"] .+
                                                            r["process_heat_thermal_load_series_mmbtu_per_hour"])
    ...
    r["total_heating_boiler_fuel_load_series_mmbtu_per_hour"] = (r["dhw_boiler_fuel_load_series_mmbtu_per_hour"] .+ 
                                                                r["space_heating_boiler_fuel_load_series_mmbtu_per_hour"] .+
                                                                r["process_heat_boiler_fuel_load_series_mmbtu_per_hour"])
    ...
    r["annual_calculated_total_heating_thermal_load_mmbtu"] = (r["annual_calculated_dhw_thermal_load_mmbtu"] + 
                                                                r["annual_calculated_space_heating_thermal_load_mmbtu"] +
                                                                r["annual_calculated_process_heat_thermal_load_mmbtu"])
