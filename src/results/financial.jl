...
- `lifecycle_timed_production_incentive`
...
function add_financial_results(m::JuMP.AbstractModel, p::REoptInputs, d::Dict; _n="")
    ...
    r["lifecycle_timed_production_incentive"] = value(m[Symbol("TotalTimedProductionIncentive"*_n)]) # Timed Production incentives
