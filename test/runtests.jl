...
elseif "CPLEX" in ARGS
    ...
    @testset "Solar dataset" begin
        ...
        # 3. Tried:
        #Paris, France 48.85739646386868, 2.351574495215523
        #Younde, Cameroon 3.8603988398663125, 11.528880303663136
        #Cape Town, South Africa -33.919112989651936, 18.42966906777456
        #Ho Chi Minh City
        #Addis Ababa
        latitude, longitude = 9.018176665420894, 38.75227988240302
        radius = 0
        dataset, distance, datasource = REopt.call_solar_dataset_api(latitude, longitude, radius)
        @test dataset ≈ "intl"
