        ...
        @testset "Emissions and Renewable Energy Percent" begin
            ...
            for i in range(1, stop=3)
                ...
                elseif i == 3
                    ...
                    @test results["Site"]["onsite_renewable_electricity_fraction_of_elec_load"] ≈ results["Site"]["annual_onsite_renewable_electricity_kwh"] / results["ElectricLoad"]["annual_kwh_with_thermal_conversion"] rtol=0.001 #0.044285 atol=1e-4
                    ...
                    @test results["Site"]["onsite_renewable_energy_fraction_of_total_load"] ≈ annual_RE_kwh / (annual_heat_kwh + results["ElectricLoad"]["annual_kwh_with_thermal_conversion"]) rtol=0.001
                end
            end
        end
